...
HUMMINGBIRD_MASTER_KEY := device/bn/hummingbird/prebuilt/boot/master_boot.key
...
$(INSTALLED_BOOTIMAGE_TARGET): \
		$(MKBOOTIMG) $(INSTALLED_BOOTIMAGE_TARGET).temp $(HUMMINGBIRD_MASTER_KEY)
	$(hide) cp $(HUMMINGBIRD_MASTER_KEY) $@
...
$(INSTALLED_RECOVERYIMAGE_TARGET): \
		$(MKBOOTIMG) $(INSTALLED_RECOVERYIMAGE_TARGET).temp $(HUMMINGBIRD_MASTER_KEY)
	$(hide) cp $(HUMMINGBIRD_MASTER_KEY) $@
	$(hide) dd if=$@.temp of=$@ bs=1048576 seek=1
	$(hide) $(call assert-max-image-size,$@, \
